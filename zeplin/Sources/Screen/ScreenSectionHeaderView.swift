...
final class ScreenSectionHeaderView: UICollectionReusableView, Reusable {
  // MARK: - Properties
  var bag = DisposeBag()
  private let titleLabel: UILabel = .create(text: "".localized(), numberOfLines: 1, textAlignment: .left, textColor: .white, font: .bold(22))
